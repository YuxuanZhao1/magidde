...
model = stan_model("Linear_interpolation.stan")
allresult =
  foreach (
    i = 1:nsim,
    .errorhandling = "pass",
...
stopCluster(cl)
save.image(paste0("linear_interpolation_level", nlevel, ".RData"))
load(paste0("linear_interpolation_level", nlevel, ".RData"))
